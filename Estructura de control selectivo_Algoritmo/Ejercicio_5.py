...
salidas 
venta total del mes departamentos --> int --> ventotal1 
""" 
s = int(input ("ingresar salario"))
vd1 = int (input ("ingresar ventas echas"))
vd2 = int (input ("ingresar ventas echas"))
vd3 = int (input ("ingresar ventas echas))
